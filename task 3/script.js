...
function drawLoop() {
  ...
  grd.addColorStop(0, "#ff3939"); // red
  grd.addColorStop(0.5, "#fcff42"); // yellow
  grd.addColorStop(1, "#1ff924"); // green
...
// Ray casting: Is central dot inside path?
...
// Scoring: variance from average radius
